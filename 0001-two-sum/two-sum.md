# [Brute Force to solve the Two-Sum Problem on C language](https://leetcode.com/problems/two-sum/solutions/3129948/brute-force-to-solve-the-two-sum-problem-on-c-language/)
